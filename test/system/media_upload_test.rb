...
class MediaUploadTest < ApplicationSystemTestCase
  test "upload mp3 and validate display" do
    ...
    attach_file("upload-file-input", Rails.root.join("test", "fixtures", "files", "test_audio.mp3"), make_visible: true)
  ...
  test "upload mp4 and validate display" do
    ...
    attach_file("upload-file-input", Rails.root.join("test", "fixtures", "files", "test_video.mp4"), make_visible: true)
  ...
  test "upload mov and validate display" do
    ...
    assert_no_selector "video"
    attach_file("upload-file-input", Rails.root.join("test", "fixtures", "files", "test_video.mov"), make_visible: true)
